...
export default function Process() {
    ...
    return (
        <div className="min-h-screen pt-32 pb-20 w-full overflow-hidden">
            <div className="max-w-4xl mx-auto px-6 md:px-12 w-full">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="mt-32 p-12 rounded-[32px] border border-white/10 bg-white/[0.02] text-center flex flex-col items-center shadow-2xl"
                >
