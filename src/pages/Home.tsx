    ...
    <>
      <main className="relative w-full flex flex-col items-center">
        ...
        <section className="relative w-full max-w-5xl mx-auto px-6 py-20 flex flex-col items-center justify-center text-center mt-20 overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-white/5 blur-[120px] rounded-full pointer-events-none -z-10" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[150px] bg-white/5 blur-[80px] rounded-full pointer-events-none -z-10" />
