...
import { ArrowRight, Zap, ShieldCheck, Target, Eye, Linkedin, Github, Users, TrendingUp, Calendar } from "lucide-react";
import HarshImage from "../assets/Harsh.webp";
import SayanImage from "../assets/Sayan.webp";
        ...
        <main className="relative w-full min-h-screen pb-24 flex flex-col items-center">
            ...
            <section className="relative w-full pt-32 pb-24 flex flex-col items-center z-10 text-center max-w-5xl px-6">
                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <a href="/works" className="px-8 py-3.5 bg-white text-black font-bold uppercase tracking-widest text-xs rounded-full hover:bg-neutral-200 transition-all">
                            View Work
                        </a>
                        <a href="/contact" className="px-8 py-3.5 border border-white/20 bg-white/5 text-white font-bold uppercase tracking-widest text-xs rounded-full hover:bg-white/10 transition-all">
                            Talk To Us
                        </a>
                    </div>
                </motion.div>
            ...
            <section className="w-full max-w-7xl mx-auto px-6 md:px-12 py-32">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <div>
                            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">Our 'Growth First' Philosophy</h2>
            ...
            <section className="w-full max-w-7xl mx-auto px-6 md:px-12 py-32 text-center">
                <motion.div
                    ...
                    className="mb-16"
                >
                    <h2 className="text-4xl font-display font-bold mb-4">A Vision for the Digital Future</h2>
            ...
            <section className="w-full max-w-7xl mx-auto px-6 md:px-12 py-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    {teamMembers.map((member, idx) => (
                        ...
                        >
                            <div className="w-52 h-52 rounded-3xl overflow-hidden mb-8 border-2 border-white/10">
                            ...
                            <div className="flex gap-4">
                                ...
                                {(member as any).github && <a href={(member as any).github} className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 transition-all"><Github className="w-4 h-4" /></a>}
                            </div>
                        </motion.div>
                    ))}
                </div>
            ...
            <section className="w-full max-w-5xl mx-auto px-6 py-32 text-center flex flex-col items-center">
                <div className="p-16 border border-white/10 rounded-3xl w-full bg-white/[0.02] relative overflow-hidden group">
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        <a href="/book" className="px-10 py-4 bg-white text-black font-bold uppercase tracking-widest text-xs rounded-full hover:bg-neutral-200 transition-all shadow-[0_0_30px_rgba(255,255,255,0.2)]">
                            Book a Free Audit
                        </a>
                        <a href="/contact" className="px-10 py-4 border border-white/20 bg-white/5 text-white font-bold uppercase tracking-widest text-xs rounded-full hover:bg-white/10 transition-all">
                            Talk To Sales
                        </a>
                    </div>
