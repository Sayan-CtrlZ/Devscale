...
const BookingMockups = () => (
    <MockupFrame>
        ...
        <div className="grid grid-cols-7 gap-1 text-center text-xs mb-6 text-white">
        ...
        <div className="border-t border-white/10 pt-4 flex flex-col gap-2">
            <div className="flex items-center justify-between p-2 rounded-lg bg-green-500/10 border border-green-500/20">
                ...
                <span className="text-xs font-medium text-white">10:00 AM</span>
            </div>
        </div>
    </MockupFrame>
);
...
const CommerceMockups = () => (
    <div className="flex flex-col gap-4">
        <MockupFrame>
            <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-4 text-white">
            ...
            <div className="flex items-center gap-4 mb-4">
                ...
                <div className="text-sm font-bold text-white">$129.00</div>
            </div>
...
export default function Services() {
    ...
    return (
        <div className="min-h-screen pt-24 pb-20 w-full bg-black">
                        ...
                        >
                            ...
                            <div className="flex-1 flex flex-col gap-8">
                                <div>
                                    ...
                                    <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-white">{service.title.split(' ')[0]} <span className="text-gradient-violet">{service.title.split(' ').slice(1).join(' ')}</span></h2>
                                ...
                                <Link href="/book" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white text-black font-bold text-xs uppercase tracking-widest mt-2 hover:bg-neutral-200 transition-colors w-max shadow-[0_0_20px_rgba(255,255,255,0.2)]">
            ...
            <section className="relative w-full max-w-5xl mx-auto px-6 py-32 mt-20 text-center flex flex-col items-center">
                ...
                <div className="p-12 md:p-16 rounded-[40px] border border-white/10 bg-black/50 backdrop-blur-xl shadow-2xl w-full flex flex-col items-center gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-6">
                        ...
                        <Link href="/contact" className="px-8 py-4 bg-white/5 border border-white/20 text-white font-bold uppercase tracking-widest text-xs rounded-full hover:bg-white/10 transition-all">
                            Contact Us
                        </Link>
                    </div>
                </div>
