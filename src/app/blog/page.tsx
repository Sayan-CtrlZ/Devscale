...
export default function BlogList() {
    ...
    return (
        <div className="min-h-screen pt-32 pb-24 px-4 bg-background transition-colors">
            {/* Card-like background container */}
            <div className="max-w-6xl mx-auto rounded-3xl border border-black/20 dark:border-white/10 bg-white/50 dark:bg-white/[0.03] backdrop-blur-sm p-12 md:p-16 shadow-[0_0_80px_rgba(0,0,0,0.05)] dark:shadow-[0_0_80px_rgba(255,255,255,0.02)] transition-colors">
                {/* Header */}
                <div className="mb-16">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                        {topics.map((t) => (
                            <span key={t} className="px-3 py-1 rounded-full border border-black/20 dark:border-white/10 bg-black/[0.02] dark:bg-white/5 text-[10px] uppercase tracking-widest text-black/40 dark:text-white/40 font-medium transition-colors">
                                {t}
                            </span>
                        ))}
                    </div>
