...
export default function Article() {
    return (
        <div className="min-h-screen pt-32 pb-20 px-6 md:px-12 max-w-4xl mx-auto w-full bg-black">
            <div className="mt-20">
                ...
                >
                    <h1 className="text-4xl md:text-6xl font-display font-bold leading-[1.1] mb-8 text-white">
