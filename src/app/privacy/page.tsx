...
export default function Privacy() {
    return (
        <div className="min-h-screen pt-32 pb-20 px-6 md:px-12 max-w-3xl mx-auto w-full bg-black">
            <div className="mt-20">
                ...
                <h1 className="text-4xl md:text-5xl font-display font-bold leading-[1.1] mb-8 text-white">
                    Privacy Policy
                </h1>

                <p className="text-white/40 text-xs mb-8">Last updated: March 2026</p>

                <div className="flex flex-col gap-10 text-white/70 text-sm leading-relaxed font-light">
                    <section>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-3">3. Cookies and Tracking Technologies</h2>
